"""
This file contains the functions for calculating the moment estimators for LD and LE (Lambda_2 and Lambda_1)
"""
...
def _M_half(i,j,k,l,n10,n01,n11,n00, n, f0):
    """
    The half rare version of M in appendix H
    Assuming that only A is rare
    Also assuming that n11+n01 is fixed to be nB, and all counts add to n

    Working with logs throughout to avoid overflow
    """
    nB = n01 + n11
...
def calculate_LD(n_obs, f0):
    """
    Similar to calculate_LE, but for LD

    Gives the same results as calculate_LD_manual
    """
...
def calculate_LE_half(n_obs, f0):
    """
    Calculate the numerator and denominator of Lambda_1 from haplotype counts
    """
...
def calculate_LE_numer_alternative(n_obs, f0, num_reps=1):
    ...
    (Not included in the appendix of the manuscript at this moment)
...
def _calculate_LD_Good2022(n11s, n10s, n01s, n00s, ntots, fstar):
    """
    The fully manual version copied from Good2022 LD project

    Should give the same results as calculate_LD and calculate_LD_manual
    """
