...
#ref_genome_path = "/Users/alyulina/Projects/Linkage equilibrium/uhgg/test/MGYG-HGUT-00258.fna"
#genome_annotation_path = "/Users/alyulina/Projects/Linkage equilibrium/uhgg/test/MGYG-HGUT-00258.gff"
...
#err_path = "/Users/alyulina/Projects/Linkage equilibrium/uhgg/test/MGYG-HGUT-00258_snp_annotation.err"
...
for i in range(len(genome_annotation)): # for each gene
    ...
    for j in range(len(snps)):
        ...
        if ref_codon not in genome_utils.codon_table:
            # usually because reference has an N; skipping it
            err_out.write('skipped an ambiguous ref codon in line ' + str(j) + '\n')
            continue

        if alt_codon not in genome_utils.codon_table:
            # usually because reference has an N; skipping it
