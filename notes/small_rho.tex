...
\begin{align}
    \left\langle f_{Ab}f_{aB}f_{AB}\right\rangle
...
\end{align}
is the joint moment generating function. The weighted moments can be obtained as
...
In the limit that $\gamma_A$, $\gamma_B$, and $\gamma_{\epsilon}$ are small compared to both $\rho$ and 1, the equation above reduces to
...
\begin{align}
    \quad & \quad \theta^2\rho f_0 (y-z)^2 \int_0^{\tau} \frac{\ln(1+y\tau')}{y^2(1+z\tau')^2} \Phi_x(\tau') \,d\tau'
    + \theta^2\rho f_0 (x-z)^2\int_0^{\tau} \frac{\ln(1+x\tau')}{x^2(1+z\tau')^2} \Phi_y(\tau') \,d\tau' \\\nonumber\\
    \quad &+ \theta^2\rho f_0\frac{1}{2}\frac{z^2}{y^2}\int_0^{\tau}  \frac{(1+y\tau')^2-1}{(1+z\tau')^2}\Phi_x(\tau') \,d\tau'
    + \theta^2\rho f_0\frac{1}{2}\frac{z^2}{x^2}\int_0^{\tau} \frac{(1+x\tau')^2-1}{(1+z\tau')^2}\Phi_y(\tau') \,d\tau'\\\nonumber\\
    \quad &-\theta^2\rho f_0 z\int_0^{\tau} \frac{1}{1+z\tau'} \Phi_x(\tau')\Phi_y(\tau') \,d\tau'.
\end{align}
